...
parser.add_argument('-n', action='store', dest='log_name', default="logs/CIFAR_random_samling_valida10-01-2021T13:24:43.json")
...
if args.log_name:
    ...
    (cm_array_test, cm_array_train) = conf_matrix_extract(log_opener.get_epochs())
